...
@Mod(modid = "skid+", name = "Skid+", version = "0.0.1")
public class OyVey
{
    public static final String MODID = "skid+";
    public static final String MODNAME = "Skid+";
    ...
    public static void load() {
        ...
        OyVey.LOGGER.info("Skid+ successfully loaded!\n");
    }
    
    public static void unload(final boolean unload) {
        OyVey.LOGGER.info("\n\nUnloading Skid+ by PRDS,Kura7");
        if (unload) {
        ...
        OyVey.LOGGER.info("Skid+ unloaded!\n");
    }
    ...
    public static void onUnload() {
        if (!OyVey.unloaded) {
            ...
            OyVey.configManager.saveConfig(OyVey.configManager.config.replaceFirst("skid plus/", ""));
    ...
    public void preInit(final FMLPreInitializationEvent event) {
        OyVey.LOGGER.info("I am gona gas you kike - PRDS,Kura7");
    }
    
    @Mod.EventHandler
    public void init(final FMLInitializationEvent event) {
        Display.setTitle("Skid+");
        load();
    }
    
    static {
        LOGGER = LogManager.getLogger("Skid+");
        OyVey.unloaded = false;
    }
}
